...
public ContinueAsGuestPage() throws IOException {
	...
	public void clickOnContinuAsGuest() {
...
//		
	...
	public void enterDetails(String Name, String Email,String Phone) {
		driver.findElement(name).sendKeys(Name);
		driver.findElement(eamil).sendKeys(Email);
